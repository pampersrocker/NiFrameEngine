...
namespace LinearMath
{
  ...
  template< typename ScalarType >
  Radian_tpl< ScalarType >::Radian_tpl( const ScalarType& scalar ) :
    m_Rad( scalar )
  {
  }
  ...
  template< typename ScalarType >
  ScalarType Radian_tpl< ScalarType >::AsDegreeValue( void ) const
  {
  ...
  template< typename ScalarType >
  bool Radian_tpl< ScalarType >::operator ==( const Radian_tpl< ScalarType >& rad ) const
  {
  ...
  template< typename ScalarType >
  const ScalarType MathHelper_tpl< ScalarType >::PI = 3.14159265358979323846f;
  ...
  Degree_tpl< ScalarType > MathHelper_tpl< ScalarType >::RadToDegree( const Radian_tpl< ScalarType >& rad )
  {
    ...
    // <=> r = alpha * (PI/180°)
    // <=> alpha = r * 180/pi
    return Degree_tpl< ScalarType >( rad.AsRadianValue() * ( 180.0f / PI ) );
  }
  ...
  {
    return (ScalarType)sin( (ScalarType)scalar.AsRadianValue() );
  }
  ...
  {
    return (float)sqrt( (double)scalar );
  }

  template< typename ScalarType >
  ScalarType MathHelper_tpl< ScalarType >::Max( const ScalarType& scalar1, const ScalarType& scalar2 )
  {
  ...
  template< typename ScalarType >
  ScalarType MathHelper_tpl< ScalarType >::Abs( const ScalarType& scalar )
  {
    return scalar < 0 ? -scalar : scalar;
  }

  template< typename ScalarType >
  ScalarType MathHelper_tpl< ScalarType >::Lerp( const ScalarType& p1, const ScalarType& p2,
    const ScalarType& lerpVal )
  {
    return p1 + ( ( p2 - p1 ) * lerpVal );
  }

  template< typename ScalarType >
  const ScalarType MathHelper_tpl< ScalarType >::GetPI()
  {
    return PI;
  }

  template< typename ScalarType >
  Degree_tpl< ScalarType >::Degree_tpl( void ) :
    m_Degree( 0.0f )
  {
  }
  ...
  template< typename ScalarType >
  Degree_tpl< ScalarType >::Degree_tpl( const Degree_tpl< ScalarType >& deg ) :
  ...
  template< typename ScalarType >
  Degree_tpl< ScalarType >::operator Radian_tpl< ScalarType >( void )const
  {
    return MathHelper_tpl< ScalarType >::DegreeToRad( *this );
  }

  template< typename ScalarType >
  ScalarType Degree_tpl< ScalarType >::AsRadianValue( void ) const
  {
    return MathHelper_tpl< ScalarType >::DegreeToRad( *this ).AsRadianValue();
  }

  template< typename ScalarType >
  Radian_tpl< ScalarType > Degree_tpl< ScalarType >::ToRad( void ) const
  {
    return MathHelper_tpl< ScalarType >::DegreeToRad( *this );
  }

  template< typename ScalarType >
  ScalarType Degree_tpl< ScalarType >::AsDegreeValue( void ) const
  {
    return m_Degree;
  }
  ...
  template< typename ScalarType >
  bool Degree_tpl< ScalarType >::operator ==( const Degree_tpl< ScalarType >& deg ) const
  {
