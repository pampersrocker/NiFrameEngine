...
#include "NFDirectXRenderDevice.hpp"
...
extern "C"
{
  ...
  {
    *renderDevice = new nfe::D3DRenderDevice( hdll );
...
namespace nfe
{
  D3DRenderDevice::D3DRenderDevice( HINSTANCE hDLL ) :
    m_hDLL( hDLL ),
    m_pD3D( nullptr ),
    m_AdpaterIdentifier( new vector< D3DADAPTER_IDENTIFIER9 >() ),
    m_AdapterParameters( vector< RenderDeviceParams* >() ),
    m_DeviceResolutions( new vector< vector< D3DResolution* >* >() ),
    m_Windowed( new vector< vector< StringableBool* >* >() ),
    m_D3DDevTypes( new vector< vector< D3DDevTypeStringable* >* >() ),
    m_BufferTypes( new vector< vector< BufferTypeStringable* >* >() ),
    m_ZBufferTypes( new vector< vector< BufferTypeStringable* >* >() ),
    m_MultiSampleTypes( new vector< vector< D3DMultiSample* >* >() ),
    m_MultiSampleQualities( new vector< vector< D3DMultiSampleQuality* >* >() ),
    m_SelectedValues( new map< String, uint32 >() ),
    VIDEOMODE( "VideoMode" ),
  ...
  D3DRenderDevice::~D3DRenderDevice()
  {
    ...
    for( vector< vector< D3DResolution* >* >::iterator d3dResolutions = m_DeviceResolutions->begin();
    ...
    for( vector< vector< StringableBool* >* >::iterator iterator = m_Windowed->begin();
    ...
    for( vector< vector< D3DDevTypeStringable* >* >::iterator iterator = m_D3DDevTypes->begin();
    ...
    for( vector< vector< BufferTypeStringable* >* >::iterator iterator = m_BufferTypes->begin();
    ...
    for( vector< vector< BufferTypeStringable* >* >::iterator iterator = m_ZBufferTypes->begin();
    ...
    for( vector< vector< D3DMultiSample* >* >::iterator iterator = m_MultiSampleTypes->begin();
    ...
    for( vector< vector< D3DMultiSampleQuality* >* >::iterator iterator = m_MultiSampleQualities->begin();
  ...
  const nfe::RenderDeviceParams* D3DRenderDevice::GetRenderParams( void ) const
  {
  ...
  void D3DRenderDevice::LoadDeviceResolutions( uint32 deviceID, RenderDeviceParameterList* paramList )
  {
    ...
    vector< D3DResolution* >* d3dResolutions = new vector< D3DResolution* >();

    vector< IStringableObject* >* modeVector = new vector< IStringableObject* >();
  ...
  {
    vector< StringableBool* >* modes = new vector< StringableBool* >();

    vector< IStringableObject* >* paramListMember = new vector< IStringableObject* >();
  ...
  {
    vector< D3DDevTypeStringable* >* devType = new vector< D3DDevTypeStringable* >();

    vector< IStringableObject* >* paramListVector = new vector< IStringableObject* >();
  ...
  {
    vector< BufferTypeStringable* >* bufferTypes = new vector< BufferTypeStringable* >();

    vector< IStringableObject* >* paramListVector = new vector< IStringableObject* >();

    vector< D3DFORMAT >* vec = new vector< D3DFORMAT >();
  ...
  {
    vector< BufferTypeStringable* >* zBufferTypes = new vector< BufferTypeStringable* >();

    vector< IStringableObject* >* paramListVector = new vector< IStringableObject* >();

    vector< D3DFORMAT > vec = vector< D3DFORMAT >();
  ...
  {
    vector< D3DMultiSample* >* multiSampleTypes = new vector< D3DMultiSample* >();
  ...
  {
    vector< D3DMultiSampleQuality* >* multiSampleQualities = new vector< D3DMultiSampleQuality* >();
  ...
  void D3DRenderDevice::FillBufferTypeVector( vector< D3DFORMAT >* vec )
  {
  ...
  MeshPtr D3DRenderDevice::CreateMesh( VertexBuffer* vertexBuffer, IndexBuffer* indexBuffer )
  {
